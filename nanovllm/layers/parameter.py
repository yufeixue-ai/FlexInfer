...
class BaseParameter(Parameter):
    ...
    def __init__(self, data: torch.Tensor | None, weight_loader: Callable):
...
class _ColumnParameter(BaseParameter):
    ...
    def load_merged_column_weight(self, loaded_weight: torch.Tensor, **kwargs):
        ...
        if (
            isinstance(self, (PackedColumnParameter, PackedParameter))
...
class ModelWeightParameter(_ColumnParameter, RowParameter):
    """
...
class GroupQuantScaleParameter(_ColumnParameter, RowParameter):
    """
...
class ChannelQuantScaleParameter(_ColumnParameter):
    """
    Parameter class for weight scales loaded for weights with
    channel-wise quantization. Equivalent to _ColumnParameter.
    """

    pass


class PerTensorScaleParameter(BaseParameter):
    """
...
class PackedColumnParameter(_ColumnParameter):
    """
    Parameter for model parameters which are packed on disk
    and support column parallelism only. See PackedParameter
...
class PackedParameter(ModelWeightParameter):
    """
...
def permute_param_layout_(
    param: BaseParameter, input_dim: int, output_dim: int, **kwargs
) -> BaseParameter:
    """
